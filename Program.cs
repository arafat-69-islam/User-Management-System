...
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        ...
        if (!await context.Users.AnyAsync(u => u.Email == "admin@gmail.com"))
        {
            ...
            {
                Name = "Administrator",
                Email = "admin@gmail.com", // Changed to admin@gmail.com
            ...
            initialLogger.LogInformation("Admin user created successfully with username 'admin' and password '123'");
        }
        else
        {
...
finalLogger.LogInformation("User Management System started successfully");
finalLogger.LogInformation("Admin credentials: username='admin', password='123'");
app.Run();
